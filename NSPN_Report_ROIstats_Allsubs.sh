...
#==============================================================================
# USAGE: NSPN_Report_ROIstats_Allsubs.sh <data_dir>
#==============================================================================
function usage {

    echo "USAGE: NSPN_Report_ROIstats_Allsubs.sh <data_dir>"
...
for parc in aparc 500.aparc lobesStrict; do
    ...
    for stat in thickness thicknessstd; do
        ...
        # Extract the sulcal depth before you go through
        # the different quantitative measures
        measure=sulcdepth
